                    ...
                    <tr key={p.uid} className="hover:bg-neutral-50/50">
                      <td className="px-6 py-4">
                        <div className="flex items-center gap-3">
                          <img
                            src={p.photoURL || 'https://images.unsplash.com/photo-1534528741775-53994a69daeb?auto=format&fit=crop&w=80&q=80'}
                            alt={p.displayName}
                          ...
                          <div className="text-left">
                            ...
                            <p className="text-[9px] text-neutral-400 font-mono mt-0.5">{p.email}</p>
                          </div>
                        </div>
                      </td>
                      <td className="px-6 py-4">
                ...
                {allAudit.length === 0 ? (
                  ...
                  allAudit.map((a) => (
                    <tr key={a.id} className="hover:bg-neutral-50/50">
                      ...
                      <td className="px-6 py-4">
                        <p className="font-extrabold text-neutral-900">{a.namaLengkap}</p>
                        <p className="text-[10px] text-neutral-400 font-mono mt-0.5">{a.email}</p>
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap">
                        <span className={`inline-flex items-center px-2 py-0.5 rounded-full text-[10px] font-bold ${
                          a.role === 'admin' 
          ...
          <div className="bg-white rounded-2xl shadow-2xl max-w-md w-full border border-neutral-200 overflow-hidden text-left animate-in fade-in zoom-in-95">
            <div className="bg-[#6B0D18] p-5 text-white flex justify-between items-center border-b-4 border-[#D4AF37]">
              <div>
                ...
                <p className="text-[10px] text-red-100 mt-0.5">{editingProfile.email}</p>
              </div>
              <button
                type="button"
