        ...
        <div className="lg:col-span-3 bg-white p-5 rounded-2xl shadow-sm border border-slate-200">
          <div className="flex flex-col sm:flex-row items-center gap-5">
            <div className="relative group cursor-pointer" title="Klik untuk ubah pas foto">
              <img
                src={user.photoURL || 'https://images.unsplash.com/photo-1544005313-94ddf0286df2?auto=format&fit=crop&w=120&q=80'}
                  ...
                  onChange={async (e) => {
                    ...
                    if (file) {
                      if (file.size > 1.5 * 1024 * 1024) {
                        onShowMessage('Ukuran file foto maksimal adalah 1.5MB.', 'warning');
                        return;
                      }
                      const reader = new FileReader();
                      reader.onloadend = async () => {
                        ...
                        try {
                          ...
                          onUpdateProfile({ ...user, photoURL: base64Photo });
